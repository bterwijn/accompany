...
int main(int argc,char **argv)
{
  ...
  optionsDescription.add_options()
    ...
    ("stateThreshold,s",program_options::value<double>(&stateThreshold)->default_value(-0.05),"threshold on the kalman filter state")
    ("appearanceThreshold,a",program_options::value<double>(&appearanceThreshold)->default_value(-0.35),"threshold on the appearance")
